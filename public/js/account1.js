...
// local_api._list('document', { tree_path: '^,0,447' }, 'did,tree_path,id', '', 1, -1, $.cookie('appkey'), function (res) {
   
//     res.data.forEach(ele => { 
//         var tree_path = ',1,447' + ele.tree_path.slice(6, ele.tree_path.length); 
//         console.log(tree_path) 
//         // var upjson = {tree_path:tree_path};
//         // var query = {id:ele.id};
//         // local_api._update('document',query,upjson,$.cookie('appkey'),function(d){console.log(d)})
//     })
// })
